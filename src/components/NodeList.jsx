          ...
          {personaggi.map((p) => (
            <div key={p.id} className="d-flex gap-2 align-items-center">
              ...
              <input
                ...
                value={p.nome}
                onChange={(e) =>
                  onUpdatePersonaggio({ ...p, nome: e.target.value })
                }
              />
              <button
                ...
                onClick={() =>
                  openConfirm(
                    () => onDeletePersonaggio(p.id),
                    "Vuoi eliminare questo personaggio?",
                  )
                }
              >
                ✕
      ...
      <div>
        <div className="d-flex justify-content-between align-items-center mb-2">
          <div>
            ...
            {dialoghi && (
              <h6 className="small ps-1 fst-italic">
                Dialogo iniziale: {meta.dialogoIniziale}
              </h6>
            )}
          </div>
          ...
          <button
            ...
            onClick={onAddDialogo}
            disabled={personaggi.length === 0}
          >
            + Aggiungi
          </button>
        </div>
        ...
        <div className="d-flex flex-column gap-2">
          {dialoghi.map((dialogo) => (
            <div
              ...
              style={{
                background: dialogo.id === selectedId ? "#EEEDFE" : "white",
                cursor: "pointer",
              }}
            >
              <div className="d-flex justify-content-between align-items-start">
                <div
                  ...
                  onClick={() => onSelectDialogo(dialogo.id)}
                >
                  <div className="text-muted small mb-1 d-flex align-items-center gap-1">
                    ...
                    {orfani.has(dialogo.id) && (
                      <span
                        ...
                        title="Dialogo non raggiungibile"
                      >
                        orfano
                      </span>
                    )}
                  ...
                  {dialogo.battute.length > 2 && (
                    <div className="text-muted small">
                      +{dialogo.battute.length - 2} battute
                    </div>
                  )}
                ...
                <div className="btn-group w-auto h-auto">
                  <button
                    className="border-0 bg-transparent btn btn-sm"
                    value={dialogo.id}
                  ...
                  >
                    {dialogo.id === meta.dialogoIniziale ? (
                      <svg
                        ...
                        fill="#FFFF55"
                      >
                        <path d="m209-93 103-333L38-641h334l108-332 108 332h334L648-426 752-93 481-299 209-93Z" />
                      </svg>
                    ) : (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        fill="#000000"
                      >
                        <path d="m384-334 96-74 96 74-36-122 90-64H518l-38-124-38 124H330l90 64-36 122ZM199-69l106-346L22-617h347l111-364 111 364h347L655-415 762-69 481-283 199-69Zm281-420Z" />
                      </svg>
                    )}
                  </button>
                  ...
                  <button
                    ...
                    onClick={() =>
                      openConfirm(
                        () => onDeleteDialogo(dialogo.id),
                        "Vuoi eliminare questo dialogo?",
                      )
                    }
                  >
                    ✕
